...
a = load_timm_pretrained_weights(model, model_name, save_path='deit_small_distilled_patch16_224.fb_in1k.pth')

a = load_timm_pretrained_weights(model, model_name, checkpoint_path='deit_small_distilled_patch16_224.fb_in1k.pth')
