...
a = load_timm_pretrained_weights(model, model_name, save_path='vit_base_patch16_224.augreg_in21k_ft_in1k.pth')

a = load_timm_pretrained_weights(model, model_name, checkpoint_path='vit_base_patch16_224.augreg_in21k_ft_in1k.pth')
